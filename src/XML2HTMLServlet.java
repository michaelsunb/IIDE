...
public class XML2HTMLServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(!(Usertype.equals("admin") || Usertype.equals("registed"))) {
				//only admin and registered user can see this page
				response.sendRedirect("../noAccess.jsp");
			}
			
	        Document doc = builder.build("file:///Volumes/Storage/Dev/JSP/IIDE/WebRoot/upload/DOC0000" + docID + ".xml");
		...
		StreamSource xsltSource = 
		  new StreamSource(new FileInputStream("/Volumes/Storage/Dev/JSP/IIDE/WebRoot/upload/DOC0000" + docID + ".xsl"));
